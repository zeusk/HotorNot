...
sentiment_hist <- sentiment_hist + geom_histogram(bins=30, data=subset(score_data, labels=="p")) 
sentiment_hist <- sentiment_hist + geom_histogram(bins=30, data=subset(score_data, labels=="n"));
...
msg.trap <- capture.output(suppressMessages(ggsave(filename="twitter_sentiment_raw.png")))
...
msg.trap <- capture.output(suppressMessages(ggsave(filename="twitter_sentiment_kernel.png")))
...
msg.trap <- capture.output(suppressMessages(ggsave(filename="twitter_sentiment_volume.png")))
